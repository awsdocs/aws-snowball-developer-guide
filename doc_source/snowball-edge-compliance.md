...
# Compliance Validation for Snowball<a name="snowball-edge-compliance"></a>

Third\-party auditors assess the security and compliance of Snowball as part of multiple AWS compliance programs, such as SOC, PCI, FedRAMP, HIPAA, and others\. 
...
Your compliance responsibility when using Snowball is determined by the sensitivity of your data, your organization’s compliance objectives, and applicable laws and regulations\. AWS provides the following resources to help with compliance:
